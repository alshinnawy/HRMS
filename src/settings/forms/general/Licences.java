 ...
 * @author amal
 */
public class Licences extends javax.swing.JFrame
{
   Common comObj;

    /**
     * Creates new form Licences
     */
    public Licences()
    {
        initComponents();
    ...
    private void initComponents()
    {
        ...
        setPreferredSize(new java.awt.Dimension(1260, 650));
        setResizable(false);

        jLabel3.setText("icnnn");
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(Licences.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
