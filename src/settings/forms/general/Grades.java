...
//        }
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
         ...
         if(name.getText().length()>0 &&name.getText().length()<=100)
        {
           ...
           String  gradeNames=name.getText().trim();
              GradeHandler gh=new GradeHandler();
            try {
                 DefaultTableModel dtm =(DefaultTableModel) table.getModel();
                  dtm.setRowCount(0);
               Grade[] list =gh.getGradeByName(gradeNames);
                ...
                if(list !=null &&list.length>0)
                {
                    ...
                    newRow.addElement(list[i].getGradeName()); 
                    newRow.addElement(list[i].getGradeId());  
                     dtm.addRow(newRow);
                      }
                      table.setModel(dtm);
                    table.updateUI();
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
         ...
         if(name.getText().length()>0 &&name.getText().length()<=100)
        {
            //JOptionPane.showMessageDialog(null, "enter بحث");
             Grade gd=new  Grade();
           gd.setGradeName(name.getText().trim());
               GradeHandler gh=new  GradeHandler();
            
             try {
                 DefaultTableModel dtm =(DefaultTableModel) table.getModel();
                  dtm.setRowCount(0);
                  GradePk mpk= gh.addGrade(gd);
                 
                 JOptionPane.showMessageDialog(null, "تمت الاضافة "); 
                 viewAll();
                  name.setText("");
//                   Grade[] list =gh.getAllGrade();
//                 if(list !=null &&list.length>0)
//                {
//                     for(int i=0;i<list.length;i++)
//                     {
...
//             
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        {
             Grade dg=new Grade();
             GradeHandler dh=new GradeHandler();
             GradePk dpk=new GradePk((int)table.getValueAt(selected,1));
              dg.setGradeId(dpk.getGradeId());
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        if(selected >=0 && newname.getText().length()>0 &&newname.getText().length()<=100)
        {
             ...
             GradeHandler dh=new GradeHandler();
             GradePk dpk=new GradePk((int)table.getValueAt(selected,1));
             dg.setGradeName(newname.getText().trim());
             dg.setGradeId(dpk.getGradeId());
             
            try {
                dh.updateGrade(dpk, dg);
    ...
    private void viewAll() throws GradeDaoException
    {
    GradeHandler gh=new  GradeHandler();
      DefaultTableModel dtm =(DefaultTableModel) table.getModel();
                  dtm.setRowCount(0);
